...
(define-key attic-minor-mode-map (kbd "M-C-b")      'backward-word)
...
(define-key attic-minor-mode-map (kbd "<escape>")   'attic-lock-enable)
(define-key attic-minor-mode-map (kbd "M-j")        'attic-lock-enable)
(define-key attic-minor-mode-map (kbd "C-M-j")      'attic-lock-enable)
...
(define-key attic-minor-mode-map (kbd "C-M-k")      'delete-forward-char)
(define-key attic-lock-minor-mode-map (kbd "k")     'delete-backward-char)
(define-key attic-minor-mode-map (kbd "M-k")        'delete-forward-char)
