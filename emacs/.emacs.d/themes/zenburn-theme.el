...
(let ((class '((class color) (min-colors 89)))
      ...
      (zenburn-fg "#dcdccc")
      (zenburn-fg-comment "#dcdccc")
      (zenburn-fg-1 "#656555")
      (zenburn-bg-1 "#4b4b4b")
      (zenburn-bg-05 "#4b4b4b")
      ;(zenburn-bg "#3f3f3f")
      (zenburn-bg "#000000")
      (zenburn-bg+1 "#4b4b4b")
      (zenburn-bg+2 "#4b4b4b")
      ...
      (zenburn-green-1 "#4bff3")
      (zenburn-green   "#616161") ; comments
      (zenburn-green+1 "#cb8bb")
      (zenburn-green+2 "#ca0a3")
      (zenburn-green+3 "#c888b")
      (zenburn-green+4 "#c7073")
      (zenburn-cyan    "#93e0e3")
      ...
      (zenburn-red+1 "#79b579")
      (zenburn-red   "#79b579")
      (zenburn-red-1 "#79b579")
      (zenburn-red-2 "#79b579")
      (zenburn-red-3 "#79b579")
      (zenburn-red-4 "#79b579")

      (zenburn-blue+1 "#cdae33")
      (zenburn-blue   "#cdae33")
      (zenburn-blue-1 "#ff0000")
      (zenburn-blue-2 "#d72323")
      (zenburn-blue-3 "#9c6363")
      (zenburn-blue-4 "#8c5353")
      (zenburn-blue-5 "#366060")
  ...
  (custom-theme-set-faces
   ...
   `(mew-face-body-comment ((t (:foreground ,zenburn-fg-comment :slant italic))))
