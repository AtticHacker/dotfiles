...
(define-key attic-minor-mode-map (kbd "C-l") 'forward-to-word)
(define-key attic-minor-mode-map (kbd "C-h") 'backward-to-word)
...
(define-key attic-minor-mode-map (kbd "C-x C-s") (lambda()
    (interactive)
...
(define-key attic-minor-mode-map (kbd "C-j C-<SPC>") 'pop-to-mark-command)
...
(define-key attic-minor-mode-map (kbd "C-j C-s") 'flyspell-mode)
(define-key attic-minor-mode-map (kbd "C-j C-c") 'comment-or-uncomment-region)
